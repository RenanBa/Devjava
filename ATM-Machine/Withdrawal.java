...
public class Withdrawal extends Transaction
{
            ...
            if ( amount != CANCELED )
            {
                ...
                if ( amount <= availableBalance )
                {
                    ...
                    if ( cashDispenser.isSufficientCashAvailable( amount ) )
                    {
                        ...
                        cashDispenser.dispenseCash( amount ); // dipense cash
                        cashDispensed = true; // cash was dispensed

                        // instruction user to take cash
    ...
    private int displayMenuOfAmounts()
    {
        ...
        // array of aounts to correspond to menu numbers
        int[] amounts = { 0, 20, 40, 60, 100, 200 };

        // loop while no vailid choice has been made
        while ( userChoice == 0 )
        {
        ...
        return userChoice; // return withdrawal amount of CANCELED
    } // end method displayMenuAmount
